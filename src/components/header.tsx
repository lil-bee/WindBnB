          ...
          >
            <Box>
              ...
              >
                ...
                <Input
                  placeholder="Add guests"
                  value={(form.guestAdult || 0) + (form.guestChild || 0)}
                  type="number"
                  borderTop="none"
                  borderBottom="none"
                  focusBorderColor="white"
              ...
              >
                ...
                >
                  {city
                    .filter((c) => c.includes(form.location || ""))
                    .map((x, i) => (
                      <Box
                        display="flex"
                        alignItems="center"
                      ...
                      >
                        ...
                        <Text key={i}>
                          {x.charAt(0).toUpperCase() + x.slice(1)}, Finland
                        </Text>
                      </Box>
                    ))}
                </Box>
                <Box>
                  <VStack my="28px" align="start">
                    ...
                    <HStack>
                      <Button
                        size="xs"
                        onClick={() => handleDecrement("guestAdult")}
                      >
                        -
                      </Button>
                      <Input
                        ...
                        size="xs"
                        border="none"
                        value={form.guestAdult}
                      />
                      <Button
                        size="xs"
                        onClick={() => handleIncrement("guestAdult")}
                      >
                        +
                      </Button>
                    </HStack>
                  ...
                  <VStack my="28px" align="start">
                    ...
                    <HStack>
                      <Button
                        size="xs"
                        onClick={() => handleDecrement("guestChild")}
                      >
                        -
                      </Button>
                      <Input
                        ...
                        size="xs"
                        border="none"
                        value={form.guestChild}
                      />
                      <Button
                        size="xs"
                        onClick={() => handleIncrement("guestChild")}
                      >
                        +
                      </Button>
                    </HStack>
